...
write.csv(sample_cities_viz %>% select(city_state, date), samp_cities_file_path, row.names = FALSE)
```
...
write.csv(cleaned_data,file.path("../data/archive", paste0("final_sample", month_suffix, ".csv")), row.names = FALSE)
```
...
write.csv(undesirables_na_current,file.path("../auditing/archive", paste0("missing_current", month_suffix, ".csv")),row.names = FALSE)
write.csv(undesirables_na_historical,file.path("../auditing/archive", paste0("missing_historical", month_suffix, ".csv")),row.names = FALSE)
write.csv(undesirables_recency,file.path("../auditing/archive", paste0("no_reported_data_past_two_months", month_suffix, ".csv")),row.names = FALSE)
write.csv(remove_agencies,file.path("../auditing/archive", paste0("agencies_removed_from_sample", month_suffix, ".csv")),row.names = FALSE)
write.csv(sample_cities,file.path("../auditing/archive", paste0("sample_cities", month_suffix, ".csv")), row.names = FALSE)
```