...
```{r}
az_ucr_list_monthly <- list.files(path="C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Missouri\\State UCR")


setwd("C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Missouri\\State UCR")
...
```{r}
write.csv(combined_df, "mo_state_ucr_all.csv")
