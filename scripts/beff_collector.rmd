...
remove_agencies <- unique(non_reporters$city_state)
...
ref_df <- read.csv("C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\_Ben and Jeff work\\Ben and Jeff working files\\final_sourcing.csv")
...
```{r}
write.csv(na_two_months_previous, "scripts/auditing/na_two_months.csv")
write.csv(non_reporters, "scripts/auditing/non_reporters.csv")

#updated
folder_path1 <- "C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Data Auditing and Validation"

# Create the full file path
file_path1 <- file.path(folder_path1, "non_reporters_june_2024.csv")

write.csv(non_reporters, file = file_path1, row.names = FALSE)

```

##rapid city through march 2024; 
