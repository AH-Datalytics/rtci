...
df_mvs_12mo1 %>% select(-Agency_Type.y) %>% mutate(Agency_Type = Agency_Type.x)
...
sample_cities_viz <- sample_cities %>% 
  ...
  select(city_state_id, city_state, `Agency Name`, State, date, Agency_Type)
