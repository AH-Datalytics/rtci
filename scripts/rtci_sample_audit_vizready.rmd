...
```{r}
# Save observations with non-standard months and years to separate data frames
...
# Filter out invalid months and years from the main data frame
crime_data <- crime_data %>%
...
crime_categories <- c("CrimeCount1", "CrimeCount2") # Add other crime category columns as needed
crime_data <- crime_data %>%
