...
ldf <- lapply(list_of_dfs, reshape_data)
...
ldf1 <- lapply(ldf, reshape_wide_based_on_offense)
...
```{r}
ldf1_larc <- lapply(ldf1, process_larceny)
print(ldf1_larc[1])
```
...
write it out!
```{r}
write.csv(combined_df, "va_state_Jan23_Present.csv")
```
