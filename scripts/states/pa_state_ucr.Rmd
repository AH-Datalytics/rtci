...
folder_path <- "C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Pennsylvania\\Formatted Data"

# Create the full file path
file_path <- file.path(folder_path, "pa_jan22_present.csv")
