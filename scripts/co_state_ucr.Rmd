...
#new columns?
ldf1_1 <- as.data.frame(ldf1[1])
```
rename columns
Murder and Nonnegligent Manslaughter	Rape	Aggravated Assault	Arson	Burglary/Breaking & Entering	
Robbery	
...
Theft of Motor Vehicle Parts/Accessories	All Other Larceny	Motor Vehicle Theft

```{r}
col_names <- c("Agency Name","Murder", "Rape", "Agg Assault", "Arson",
               "Burglary/Breaking & Entering", "Robbery", "Pocket-picking",	"Purse-snatching",	"Shoplifting",
