...
```{r}
az_ucr_list_monthly <- list.files(path="C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Connecticut\\State UCR")


setwd("C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Connecticut\\State UCR")
...
col_names <- c("Agency Name", 
               "All Summary Offenses", "Criminal Homicide", "Forcible Rape Total", "Robbery Total", "Assault Total", "Burglary Total", "Larceny - Theft Total", "Motor Vehicle Theft Total", "Arson", "Human Trafficking Offenses"
)
...
columns_to_keep <- c("Agency Name", 
               ...
               "Burglary Total", 
               "Larceny - Theft Total", 
               "Motor Vehicle Theft Total", "Arson")
