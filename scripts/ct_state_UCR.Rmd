---
title: "conneticut ucr processing"
output: pdf_document
date: "2024-04-18"
updated: "2024-06-10"
---
...
```{r}
data_dir <- "C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Connecticut\\State UCR"
```
...
head(ldf[1])
```
drop first rows and extra columns
```{r}
...
col_names <- c("Agency Name", 
               "All Summary Offenses", "Criminal Homicide", "Forcible Rape Total", "Robbery Total", "Assault Total", "Burglary Total", "Larceny - Theft Total", "Motor Vehicle Theft Total", "Arson", "Human Trafficking Offenses", "Year", "Month"
)
...
columns_to_keep <- c("Agency Name", 
               "Criminal Homicide", "Forcible Rape Total", 
               "Robbery Total", 
               "Assault Total", 
               "Burglary Total", 
               "Larceny - Theft Total", 
               "Motor Vehicle Theft Total", "Arson", "Year", "Month")
...
# Apply the function to each dataframe in the list
list_of_dataframes_modified <- lapply(ldf3, keep_columns)
```
...
folder_path <- "C:\\OneDrive\\OneDrive - ahdatalytics.com\\Clients\\Real Time Crime Index\\Open Source Data\\Connecticut\\Formatted Data"

# Create the full file path
file_path <- file.path(folder_path, "ct_jan22_present.csv")
