...
# head the results to verify the adjustment
head(adjusted_list_df)
```
...
joined_df <- merge(all_combinations, combined_df, by = c("Agency Name", "Month", "Year"), all.x = TRUE)
