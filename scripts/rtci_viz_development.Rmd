...
data <- read_csv("../data/final_data.csv")  # Ensure 'final_data' is properly loaded with appropriate columns
data$Date <- as.Date(paste0(data$Year, "-", data$Month, "-01"), format = "%Y-%m-%d")
...
new experimental -- Oscar working on publishing this version to shinyapps.io, created "shiny_app_to_deploy.Rmd" file and then deploy_script.R to serve it
```{r}
library(shiny)
library(ggplot2)
library(dplyr)
